import {} from "express";
import { getAll, getById, hardDeleteAll, hardDeleteById, softDeleteAll, softDeleteById, update, } from "../services/user.service.js";
...
export async function softDeleteUserById(req, res) {
    try {
        const id = Number(req.params.id);
...
export async function hardDeleteUserById(req, res) {
    try {
        const id = Number(req.params.id);
...
export async function softDeleteAllUser(req, res) {
    try {
...
export async function hardDeleteAllUser(req, res) {
    try {
        const id = Number(req.params.id);
